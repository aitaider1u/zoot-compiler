...
public class Ou extends Binaire{
    public Ou(int n, Expression ef, Expression ed) {
        super(n, ef, ed);
    }
    ...
    public void verifier() {
        ...
        if (!this.eg.getType().equals("") && !this.ed.getType().equals("")){
            ...
            if (!this.eg.getType().equals("booleen") || !this.ed.getType().equals("booleen")){
                System.out.println("ERREUR SEMANTIQUE : " + this.noLigne + " ligne d'erreur : type incompatible pour L'operateur 'ou'   '("+this.eg.getType()+" ou "+this.ed.getType()+")'\n");
                AccumulateurErreurSemantiques.getInstance().ajouter("ERREUR SEMANTIQUE : " + this.noLigne + " ligne d'erreur : type incompatible pour L'operateur 'ou'   '("+this.eg.getType()+" ou "+this.ed.getType()+")'\n");
            }
        }
    }
    ...
    public String toMIPS(Registres registres) {
        ...
        str.append("or "+regGauche+" , "+regGauche+" , "+regDroite+"\n");
        return str.toString();
    }*/
