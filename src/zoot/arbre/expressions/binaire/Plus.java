...
public class Plus extends Binaire{
    ...
    public Plus(int n, Expression ef, Expression ed) {
        super(n, ef, ed);
    }
    ...
    public void verifier() {
        ...
        if (!this.eg.getType().equals("")){
            if (!this.eg.getType().equals("entier")){
                System.out.println("ERREUR SEMANTIQUE : " + this.noLigne + " ligne d'erreur : on ne peut pas additioner un type '"+this.eg.getType()+"'\n");
                AccumulateurErreurSemantiques.getInstance().ajouter("ERREUR SEMANTIQUE : " + this.noLigne + " ligne d'erreur : on ne peut pas additioner un type '"+this.eg.getType()+"'\n");
            }
    ...
    public String toMIPS(Registres registres){
        ...
        str.append("add "+ regGauche +", "+  regGauche + ", " + regDroite +"\n");
